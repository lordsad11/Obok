...
*Nᴏᴛᴇ*: Bʟᴀᴄᴋʟɪsᴛs ᴅᴏ ɴᴏᴛ ᴀғғᴇᴄᴛ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴs.
 ...
 ❍ /blacklist*:* Maaf, saya tidak dapat melihat daftar hitam saat ini..

Aᴅᴍɪɴ Oɴʟʏ:
 ❍ /addblacklist <triggers>*:* Dipahami. Harap berikan pemicu yang ingin Anda tambahkan ke daftar hitam, satu pemicu per baris..
 ❍ /unblacklist <triggers>*:* Baiklah, saya sudah menghapus pemicunya dari daftar hitam. Apakah ada hal lain yang memerlukan bantuan?.
